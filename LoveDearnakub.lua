...
section1:addToggle("Spectate Player",false,function(bool)
			Sp = bool
...
section1:addButton("Teleport player", function()
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players[Select].Character.HumanoidRootPart.CFrame
end
end)
...
local section = page:addSection("Admin Tool cmds for look command")
section:addButton("Reviz Admin Tools", function()
	loadstring(game:HttpGet("https://pastebin.com/raw/qFJdAC7Q"))();
end)
